...
class FontData {
    ...
    @objc func didTapNewFile() {
        ...
        viewer.present(alert, animated: true, completion: nil)
    }
...
//    ALERT: Saving file name
    ...
    @objc func didTapSaveButton() {
        ...
        self.viewer.present(alert, animated: true, completion: nil)
    }
...
//    PICKER VIEW: Picking font family and style
    ...
    @objc func didTapPickFont(){
        ...
        fontPicker.delegate = self.viewer
        self.viewer.present(fontPicker, animated: true)
    ...
    @objc func didTapPickFontSize(){
        ...
        let fontFamilyName = self.viewer.getTextViewFont().fontName
        fontValue = UIFont(name: fontFamilyName, size: CGFloat(fontSizes[0]))!
        
        alert.view.addSubview(fontSizePickerView)
        
        fontSizePickerView.dataSource = self.viewer
        fontSizePickerView.delegate = self.viewer
